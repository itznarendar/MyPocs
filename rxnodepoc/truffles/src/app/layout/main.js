            ...
            <div className="wrapper">
                ...
                <MuiThemeProvider theme={theme}>
                 {/*    <Route exact path="/" authenticated={this.state.authenticated}  loginUser={this.validateUser.bind(this)}  component={Login} /> */}
                   ...
                   <Route  exact path="/login" render={(props) =><Login  {...this.props} {...props} authenticated={this.state.authenticated}  loginUser={this.validateUser.bind(this)}/>} />
                     <Route exact path="/register" render={(props)=><Register {...this.props} {...props} />}/>
